...
for cohort in cohorts:
    ...
    for patient, group in data.groupby(['cmo_patient_id']):
        ...
        sv_cmd = f'Rscript /home/guturus1/repos/access_data_analysis/R/SV_incorporation.R -m /juno/cmo/bergerlab/access_projects/EDD_R01/{cohort}_Mutations/masterfiles/patients/{patient_string}_masterfile.tsv -o /juno/cmo/bergerlab/access_projects/EDD_R01/{cohort}_Mutations/results/{patient_string}_results'
        print(f"Executing command: {sv_cmd}")
        subprocess.run(sv_cmd, shell=True)
