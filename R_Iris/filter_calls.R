...
filter_calls = function(
  ...
  CH.path = '/data1/core006/access/production/resources/dmp_signedout_CH/versions/10Feb2020/signedout_CH.txt',
  criteria = 'stringent'
){
  # # test input section -----------------------------------------------------------
...
if (!interactive()) {
  ...
  parser$add_argument('-ch', '--chlist', type='character', default = '/data1/core006/access/production/resources/dmp_signedout_CH/versions/10Feb2020/signedout_CH.txt',
