...
## read metadata files ##
metadata<-fread(metadata_file)[,c("cmo_sample_id_plasma", "sex", "collection_date", "Timepoint")]
metadata$collection_date<-as.Date(metadata$collection_date, format="%m/%d/%y")

treatment <- NULL
if (treatment_info_file != "") {
...
cols <- c("cmo_sample_id_plasma", "collection_date", "Timepoint")
if (!is.null(treatment)) {
...
timepoints<-c("Post-NAC Pre-RC", "Post-RC", "Post-TUR Pre-NAC", "Post-TUR Pre-RC")
timepointcolors<-c("Khaki", "Aquamarine", "Light Salmon", "black")
names(timepointcolors)<-timepoints
